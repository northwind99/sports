...
/**
 * Created by evanchen on 16-05-06.
 */
public class ProfilePastGameAdapter extends RecyclerView.Adapter<ProfilePastGameAdapter.MyViewHolder> {
    ...
    private static final String TAG = ProfilePastGameAdapter.class.getName();

    public ProfilePastGameAdapter(Activity context, List<Game> gameItemList){
